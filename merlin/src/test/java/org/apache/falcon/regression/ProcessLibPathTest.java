...
public class ProcessLibPathTest extends BaseTestClass {
    ...
    public void createTestData() throws Exception {
        ...
        b.setInputFeedDataPath(baseHDFSDir + dateTemplate);
    ...
    public void testName(Method method) throws Exception {
        ...
        bundles[0].setInputFeedDataPath(baseHDFSDir + dateTemplate);
        bundles[0].setProcessValidity("2010-01-02T01:00Z", "2010-01-02T01:04Z");
        bundles[0].setProcessPeriodicity(5, TimeUnit.minutes);
        bundles[0].setOutputFeedPeriodicity(5, TimeUnit.minutes);
        bundles[0].setOutputFeedLocationData(baseHDFSDir + "/output-data" + dateTemplate);
